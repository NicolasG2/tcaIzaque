@extends('templates.main', ['titulo' => "Marcas", 'rota' => "marcas.create"])
    ...
    <div class="row">
        <div class="col">
            <table class="table align-middle caption-top table-striped">
                <caption>Tabela de <b>Marcas</b></caption>
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            <td>{{ $item->nome }}</td>
                            <td>
                                <a href="{{ route('marcas.edit', $item->id) }}" class="btn btn-success">
                                ...
                                <form action="{{ route('marcas.destroy', $item->id) }}" method="POST" id="form_{{ $item->id }}" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
